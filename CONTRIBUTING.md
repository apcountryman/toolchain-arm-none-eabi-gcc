# Contributing to toolchain-arm-none-eabi-gcc
The following is a set of guidelines for contributing to `toolchain-arm-none-eabi-gcc`.
...
- The `toolchain-arm-none-eabi-gcc` version (Git commit SHA)
